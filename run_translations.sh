...
sbatch --dependency=afterok:$post_finetuned_b shell/get_significance.sh pseudo nllb balanced
sbatch --dependency=afterok:$post_finetuned_b shell/get_significance.sh pseudo bart balanced