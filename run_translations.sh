...
# Token-balanced
tuned_1_b=$(bash shell/test.sh archaic nllb tuned balanced "$post_baseline") # finetuned on bible-data, tested on game-data (nllb-200)
tuned_2_b=$(bash shell/test.sh archaic bart tuned balanced "$post_baseline") # finetuned on bible-data, tested on game-data (mBart-50)
